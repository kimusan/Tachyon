...
//		$this->oImapTarget->logWrite('Get oImapTarget->FolderList');
		\Tachyon\Util\Log::notice('SYNC', 'Get oImapTarget->FolderList');
		...
		\Tachyon\Util\Log::notice('SYNC', 'Get oImapSource->FolderList');
