...
class Storage extends \Tachyon\Providers\AbstractProvider
{
	/**
	 * @var \Tachyon\Providers\Storage\IStorage
	 */
	private $oDriver;

	public function __construct(\Tachyon\Providers\Storage\IStorage $oDriver)
	{
	...
	{
		return \Tachyon\Providers\Storage\Enumerations\StorageType::NOBODY === $iStorageType
			|| $mAccount instanceof \Tachyon\Model\Account
			|| \is_string($mAccount);
	}
	...
	/**
	 * @param \Tachyon\Model\Account|string $mAccount
	 */
