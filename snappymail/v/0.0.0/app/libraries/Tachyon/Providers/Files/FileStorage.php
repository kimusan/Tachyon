...
class FileStorage implements \Tachyon\Providers\Files\IFiles
{
	/**
	 * @var array
	 */
	...
	public function GetFileName(\Tachyon\Model\Account $oAccount, string $sKey) /*: string|false*/
	{
	...
	public function FileSize(\Tachyon\Model\Account $oAccount, string $sKey) /*: int|false*/
	{
		$sFileName = $this->generateFullFileName($oAccount, $sKey);
	...
	private function generateFullFileName(\Tachyon\Model\Account $oAccount, string $sKey, bool $bMkDir = false) : string
	{
