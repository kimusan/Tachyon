...
(function () {
	...
	//			+ b64EncodeJSONSafe(url.replace(/ /g, '%20')),
		...
		themePreviewLink = theme => {
			if (theme.endsWith('@nextcloud')) {
				...
				return parent.OC.webroot + '/themes/' + encodeURI(theme) + '/tachyon/preview.png';
			}
	...
	*/
	...
	const
		...
		// https://github.com/the-djmaze/tachyon/issues/1150
...
<body></body>
	...
	*/
	...
	const colorSchemeMode = ko.observable('');
	...
	function setLightMode()  { applyColorScheme('light'); }
	function setDarkMode()   { applyColorScheme('dark'); }
	function setSystemMode() { applyColorScheme(''); }
	...
	*/
	...
	function runSettingsViewModelHooks(admin) {
		(USER_VIEW_MODELS_HOOKS).forEach(view =>
