...
//				$aAccountHash['login'] = $oDomain->ImapSettings()->fixUsername($aAccountHash['login']);
				$oAccount = new static;
				$oAccount->sEmail = \Tachyon\Util\IDN::emailToAscii($aAccountHash['email']);
//				$oAccount->sImapUser = \Tachyon\Util\IDN::emailToAscii($aAccountHash['login']);
			...
			\Tachyon\Util\Log::debug('ACCOUNT', $e->getMessage());
	...
	public function ImapConnectAndLogin(\Tachyon\Plugins\Manager $oPlugins, \MailSo\Imap\ImapClient $oImapClient, \Tachyon\Config\Application $oConfig) : bool
	{
...
//		$oSettings->thread_limit = \min($oSettings->thread_limit, (int) $oConfig->Get('imap', 'large_thread_limit', 50));
	...
	public function SmtpConnectAndLogin(\Tachyon\Plugins\Manager $oPlugins, \MailSo\Smtp\SmtpClient $oSmtpClient) : bool
	{
...
*/
	...
	public function SieveConnectAndLogin(\Tachyon\Plugins\Manager $oPlugins, \MailSo\Sieve\SieveClient $oSieveClient, \Tachyon\Config\Application $oConfig)
	{
	...
	private function netClientLogin(\MailSo\Net\NetClient $oClient, \Tachyon\Plugins\Manager $oPlugins) : bool
	{
/*
...
/*
	...
	public function settingsLocal() : \Tachyon\Settings
	{
		return \Tachyon\Api::Actions()->SettingsProvider(true)->Load($this);
	}
*/
