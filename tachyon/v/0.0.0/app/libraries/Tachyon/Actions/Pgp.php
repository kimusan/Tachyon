...
use Tachyon\Util\PGP\Backup;
use Tachyon\Util\PGP\Keyservers;
use Tachyon\Util\PGP\GnuPG;
...
trait Pgp
{
	 ...
	 */
	public function GnuPG() : ?\Tachyon\Util\PGP\PGPInterface
	{
...
//			$result['signatures'] = $oPart->SubParts[0];
	...
	public function DoGnupgExportKey() : array
	{
		$oPassphrase = $this->GetActionParam('isPrivate', '')
			? new \Tachyon\Util\SensitiveString($this->GetActionParam('passphrase', ''))
			: null;
		$GPG = $this->GnuPG();
