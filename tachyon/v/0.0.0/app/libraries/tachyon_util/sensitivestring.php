...
class SensitiveString /* extends SensitiveParameterValue | SensitiveParameter */ implements \Stringable, \JsonSerializable
{
	...
	{
		\strlen($value) && \Tachyon\Api::Actions()->logMask($value);
		if (\is_callable('sodium_crypto_secretbox')) {
	...
	{
		throw new \Exception("JSON serialization of 'Tachyon\Util\\SensitiveString' is not allowed");
	}
	...
	{
		throw new \Exception("Serialization of 'Tachyon\Util\\SensitiveString' is not allowed");
	}

	public function __unserialize(array $data): void
	{
		throw new \Exception("Unserialization of 'Tachyon\Util\\SensitiveString' is not allowed");
	}
}
