OC.L10N.register(
    ...
    "Tachyon" : "Tachyon",
    "Tachyon Webmail" : "דוא״ל דפדפן Tachyon",
    "Go to Tachyon Webmail admin panel" : "מעבר ללוח הניהול של הדוא״ל דרך הדפדפן Tachyon",
    ...
    "Save" : "שמירה",
    "Tachyon Webmail is not configured yet." : "דוא״ל דפדפן Tachyon אינו מוגדר עדיין.",
    "may have some" : "עשויים להיות",
    "security considerations" : "ענייני אבטחה",
    "Enter an email and password to auto-login to Tachyon." : "נא למלא שם משתמש וססמה כדי להיכנס ל־Tachyon אוטומטית.",
    "Password" : "ססמה"
},
