OC.L10N.register(
    ...
    "Tachyon" : "Rainloop",
    "Tachyon Webmail" : "Поштовий вебклієнт Rainloop",
    "Go to Tachyon Webmail admin panel" : "Перейти до панелі керування вебпошти Rainloop",
    ...
    "Save" : "Зберегти",
    "Tachyon Webmail is not configured yet." : "Поштовий клієнт Rainloop ще не налаштовано",
    "may have some" : "може мати деякі",
    "security considerations" : "проблеми з безпекою",
    "Enter an email and password to auto-login to Tachyon." : "Введіть електронну пошту та пароль для автоматичного входу в Tachyon.",
    "Password" : "Пароль"
},
