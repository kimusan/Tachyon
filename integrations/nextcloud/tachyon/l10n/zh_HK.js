OC.L10N.register(
    ...
    "Go to Tachyon Webmail admin panel" : "轉到 Tachyon Webmail 管理面板",
    ...
    "Save" : "儲存",
    "Tachyon Webmail is not configured yet." : "Tachyon Webmail尚未配置。",
    "may have some" : "可能有一些",
    "security considerations" : "安全考慮",
    "Enter an email and password to auto-login to Tachyon." : "輸入電子郵件和密碼以自動登入到Tachyon。",
    "Password" : "密碼"
},
"nplurals=1; plural=0;");
