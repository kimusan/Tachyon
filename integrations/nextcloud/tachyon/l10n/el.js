OC.L10N.register(
    ...
    "Tachyon" : "Tachyon",
    "Tachyon Webmail" : "Ηλ.Ταχυδρομείο Tachyon",
    "Go to Tachyon Webmail admin panel" : "Μετάβαση στον πίνακα διαχείρισης του Tachyon",
    ...
    "Save" : "Αποθήκευση",
    "Tachyon Webmail is not configured yet." : "Το Ηλ.Ταχυδρομείο Tachyon δεν έχει ρυθμιστεί ακόμη.",
    "may have some" : "μπορεί να έχει κάποια",
    "security considerations" : "θέματα ασφάλειας",
    "Enter an email and password to auto-login to Tachyon." : "Εισάγεται διεύθυνση ηλ.ταχυδρομείου και κωδικό πρόσβασης για αυτόματη σύνδεση στο Tachyon.",
