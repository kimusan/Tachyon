OC.L10N.register(
    ...
    "Tachyon" : "Tachyon",
    "Tachyon Webmail" : "Correu web Tachyon",
    "Go to Tachyon Webmail admin panel" : "Ves al tauler d'administració del correu web Tachyon",
    ...
    "Save" : "Desa",
    "Tachyon Webmail is not configured yet." : "Encara no s'ha configurat el correu web Tachyon.",
    "may have some" : "pot tenir algunes",
    "security considerations" : "implicacions de seguretat",
    "Enter an email and password to auto-login to Tachyon." : "Introduïu una adreça electrònica i una contrasenya per a iniciar la sessió automàticament en el Tachyon.",
