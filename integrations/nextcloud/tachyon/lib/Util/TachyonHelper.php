					...
					try {
						...
						if (!$isOIDC) {
							...
							if ($sUID) {
								...
								$session['tachyon-passphrase'] = '';
								Server::get(IConfig::class)->setUserValue($sUID, 'tachyon', 'passphrase', '');
...
//				return new TachyonResponse();
	...
	{
		return Server::get(IURLGenerator::class)->linkToRoute('tachyon.page.appGet');
	}
